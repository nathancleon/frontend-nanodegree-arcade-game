...
allEnemies[0] = new Enemy (Math.floor(Math.random() * 480) - 505, 55);
allEnemies[1] = new Enemy (Math.floor(Math.random() * 660) - 505, 220);
allEnemies[2] = new Enemy (Math.floor(Math.random() * 620) - 705, 140);
allEnemies[3] = new Enemy (Math.floor(Math.random() * 550) - 505, 140);
